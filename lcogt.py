...
def main():
    my_username = 'ckilpatrick@northwestern.edu'
    my_password = 'ThisIsNotMyRealPassword'
    progid = 'CON2021A-011' # This is the actual program ID for CIERA

    lco = lcogt(my_username, my_password, progid)

    # Example target with magnitude
    target = '2021biy'
    ra = 190.51675
    dec = 32.53544
    mag = 18.5
    ...
    response = lco.make_obs_request(target, ra, dec, mag,
